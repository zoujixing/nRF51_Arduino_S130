...
/*=========================================================================
    ...
    CFG_DEBUG                 
							  ...
							  Note   : On Arduino_nRF51822, just use Level1
    -----------------------------------------------------------------------*/
    //#define CFG_DEBUG                                  (1)
...
/*=========================================================================
	...
	#define SCHED_MAX_EVENT_DATA_SIZE       		   BLE_STACK_HANDLER_SCHED_EVT_SIZE
	#define SCHED_QUEUE_SIZE                 		   10
	/*---------------------------------------------------------------------
	Configure connect parameters update enable
		SDK_CONN_PARAMS_MODULE_ENABLE		true / false
	-----------------------------------------------------------------------*/	
	#define SDK_CONN_PARAMS_MODULE_ENABLE			   false
	#define CFG_FIRST_UPDATE_DELAY					   APP_TIMER_TICKS(5000, CFG_TIMER_PRESCALER)
	#define CFG_NEXT_UPDATE_DELAY					   APP_TIMER_TICKS(5000, CFG_TIMER_PRESCALER)
	#define CFG_MAX_UPDATE_COUNT   					   3
    /*------------------------------- GPIOTE ------------------------------*/
...
/*=========================================================================
    ...
    /*------------------------------ SECURITY -----------------------------*/
	// #define CFG_BLE_SEC_PARAM_TIMEOUT				   30						/**< Timeout for Pairing Request or Security Request (in seconds). */
	// #define CFG_BLE_SEC_PARAM_BOND					   0						/**< Perform bonding. */
...
/*=========================================================================
    ...
    -----------------------------------------------------------------------*/
	//Scan list 
	#define CFG_SCAN_REPORT_LIST_NUM					10
	//Connected default parameters
	#define CFG_CLIENT_CONNECTION_MIN_INTERVAL_MS		50
	#define CFG_CLIENT_CONNECTION_MAX_INTERVAL_MS		100
	#define CFG_CLIENT_SLAVE_LATENCY					0
	#define CFG_CLIENT_SUP_TIMEOUT						600		
	
	#define CFG_CLIENT_SCAN_INTERVAL					500
	#define CFG_CLIENT_SCAN_WINDOW						200
	#define CFG_CLIENT_SCAN_TIMEOUT						0
	
	#define CFG_DISCOVERED_SERVICE_NUM					5		/* Max number of services When discovery device*/
	#define CFG_DISCOVERED_CHARS_NUM					5		/* Max characteristic in a service */
