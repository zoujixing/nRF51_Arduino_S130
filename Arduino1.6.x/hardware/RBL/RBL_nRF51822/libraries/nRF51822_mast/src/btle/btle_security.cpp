...
ble_error_t
btle_initializeSecurity(bool clear_flag, bool enableBonding, bool requireMITM, Gap::SecurityIOCapabilities_t iocaps, const Gap::Passkey_t passkey)
{
	...
	if(clear_flag == true)
	{
		dm_init_param.clear_persistent_data = true;
	}
	else
	{
		dm_init_param.clear_persistent_data = false;
	}
...
{
	//Serial.print("The dm evt handler id : ");
	//Serial.println(p_event->event_id, HEX);
    switch (p_event->event_id) {
        case DM_EVT_SECURITY_SETUP: /* started */ {
			//Serial.println("DM_EVT_SECURITY_SETUP");
        ...
        case DM_EVT_SECURITY_SETUP_COMPLETE:
			//Serial.println("DM_EVT_SECURITY_SETUP_COMPLETE");
        ...
        case DM_EVT_LINK_SECURED: {
			//Serial.println("DM_EVT_LINK_SECURED");
        ...
        case DM_EVT_DEVICE_CONTEXT_STORED:
			//Serial.println("DM_EVT_DEVICE_CONTEXT_STORED");
