...
static const unsigned UUID_TABLE_MAX_ENTRIES = 3; /* This is the maximum number of 128-bit UUIDs with distinct bases that
...
/*!
    ...
    APP_ERROR_CHECK(uuid_type > 0, ERROR_NOT_FOUND);
                                ...
                                ble_uuid_t          *p_uuid)
{
    ...
    APP_ERROR_CHECK( sd_ble_uuid_decode(UUID::LENGTH_OF_LONG_UUID, uuid_base_le, p_uuid));
                                             ...
                                             uint16_t   *p_desc_handle)
{
    ...
    APP_ERROR_CHECK ( sd_ble_gatts_descriptor_add(char_handle,
                                                &attr_desc,
                                                p_desc_handle));
